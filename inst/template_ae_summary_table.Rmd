...
for (g in groups) {
  ...
  ARMS_ARM_A <- substr(paste0(cb_list_trt[[paste0("grp", g)]],
                              ", ", collapse = ""),
                       STRING_START,
                       nchar(paste0(cb_list_trt[[paste0("grp", g)]], 
                                    ", ", collapse = "")) - COMMA_PLUS_ONE_SPACE)
  ...
  ARMS_ARM_B <- substr(paste0(cb_list_ctr[[paste0("grp", g)]],
                              ", ", collapse = ""),
                       STRING_START,
  ...
  list_comparisons[[g]] <- as.data.frame(
    cbind(
      ...
      substr(paste0(ID_trt_list[[paste0("grp", g)]],
                    ", ", collapse = ""),
             STRING_START,
             nchar(paste0(ID_trt_list[[paste0("grp", g)]],
                          ", ", collapse = "")) - COMMA_PLUS_ONE_SPACE),
      # same with ARM B or control arm
      substr(paste0(ID_ctr_list[[paste0("grp", g)]],
                    ", ", collapse = ""),
             STRING_START,
  ...
  table_comparisons <- kableExtra::kable(list_comparisons[[g]], format = "latex",
  ...
  table_caption_1 <-paste0("Adverse Event proportion for Arm A: ",
                           ARMS_ARM_A
                           ," vs. Arm B: ",
                           ARMS_ARM_B
                           )

  list_table_1_1[[g]] <- as.data.frame(cbind(t(array_inci[, , 1, g]), t(array_inci[, , 2, g])))
  # list_table_1_1[[g]] <- list_table_1_1[[g]] %>% na.omit()
  list_table_1_1[[g]][, c(3, 10)] <- round(list_table_1_1[[g]][, c(3, 10)] *100, 1)
  list_table_1_1[[g]][, c(3, 10)] <- round(list_table_1_1[[g]][, c(3, 10)] *100, 1)
  table_display_1 <- kableExtra::kable(list_table_1_1[[g]], format = "latex",
                                      ...
                                      kableExtra::footnote(general_title = " ", 
                                                            ...
                                                            threeparttable = TRUE,
                                                            general = paste0("Naive point estimates show the (pooled) number of patients with event r",
  ...
  table_caption_2 <- paste0("Comparison of adverse event proportion for Arm A: ",
                           ARMS_ARM_A
                           ," vs. Arm B: ",
                           ARMS_ARM_B
                           )
  list_table_1_2[[g]] <- as.data.frame(cbind(t(array_inci_comp[, , 1, g]), t(array_inci_comp[, , 2, g])))
  # list_table_1_2[[g]] <- list_table_1_2[[g]] %>% na.omit()
    table_display_2 <- kableExtra::kable(list_table_1_2[[g]][, -6], format = "latex",
                                      booktabs = TRUE, digits = 3,
                                      longtable = TRUE,
                                      ...
                                      kableExtra::footnote(general_title = " ", 
                                                            footnote_as_chunk = TRUE,
                                                            threeparttable = TRUE,
                                                            general = paste0("Naive point estimates show the risk difference and ratio calculated from ",
  ...
  table_caption_3 <-paste0("Adverse event incidence rate for Arm A: ",
                           ARMS_ARM_A
                           ," vs. Arm B: ",
                           ARMS_ARM_B
                           )
  list_table_2_1[[g]] <- as.data.frame(cbind(t(array_er[, , 1, g]), t(array_er[, , 2, g])))
  # list_table_2_1[[g]] <- list_table_2_1[[g]] %>% na.omit()
    table_display_3 <- kableExtra::kable(list_table_2_1[[g]], format = "latex",
                                      booktabs = TRUE, digits = 3,
                                      longtable = TRUE,
                                      ...
                                      kableExtra::footnote(general_title = " ", 
                                                            footnote_as_chunk = TRUE,
                                                            threeparttable = TRUE,
                                                            general = paste0("Adverse event incidence rate is the exposure adjusted AE rate, the rate of patients with event per patient",
                            " year at risk.",
  ...
  table_caption_4 <- paste0("Comparison of adverse event incidence rate for Arm A: ",
                            ARMS_ARM_A
                            ," vs. Arm B: ",
                            ARMS_ARM_B
                          )
  list_table_2_2[[g]] <- as.data.frame(cbind(t(array_er_comp[, , 1, g]), t(array_er_comp[, , 2, g])))
  # list_table_2_2[[g]] <- list_table_2_2[[g]] %>% na.omit()
  if(length(list_table_2_2[[g]]) == 0) {
    print("Analysis is not applicable!")
  } else {
        table_display_4 <- kableExtra::kable(list_table_2_2[[g]][, -6], format = "latex",
                                      booktabs = TRUE, digits = 3,
                                      longtable = TRUE,
                                      col.names = c(rep(c("Naive", "mean", "median", "CRI L", "CRI U"), 2), "A>B%"),
                                      ...
                                      kableExtra::footnote(general_title = " ", 
                                                            footnote_as_chunk = TRUE,
                                                            threeparttable = TRUE,
                                                            general = paste0("Adverse event incidence rate is the exposure adjusted AE rate, the rate of patients",
