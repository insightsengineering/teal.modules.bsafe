...
# group as iterator
for (g in groups) {
  # pasting together the chosen arms of ARM A aka treatment arm and separating them
  # by comma as well as removing the last comma
  ARMS_ARM_A <- substr(
  ...
  # pasting together the chosen arms of ARM B aka control arm and separating them
  # by comma as well as removing the last comma
  ARMS_ARM_B <- substr(
