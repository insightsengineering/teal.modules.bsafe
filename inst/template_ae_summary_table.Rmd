...
* **teal.modules.bsafe version:** `r params$bsafe_version`
* **bsafe version:** `r params$pwemap_version`
...
for (g in groups) {
  ...
  # combining both ARM A and ARM B together into one list for proper display
  list_table_1_1[[g]] <- as.data.frame(cbind(array_inci[, , 1, g], array_inci[, , 2, g]))
